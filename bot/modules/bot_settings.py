...
DEFAULT_DESP = {
    ...
    "VERCEL_DOMAIN": "Vercel domain for token generation. Leave empty to disable.",
    "VERCEL_PROTECT_KEY": "Vercel protect key for token generation.",
    "VERCEL_TOKEN_TTL": "Vercel token TTL in seconds.",
